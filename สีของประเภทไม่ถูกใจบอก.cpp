...
void printIngredientWithType(const vector<string>& ingredientsList, const string& type) {
    for (size_t i = 0; i < ingredientsList.size(); i++) {
        if (i != 0) cout << ", ";
        string colorCode = getColorForIngredientType(type);
        cout << colorCode << ingredientsList[i] << "\033[0m";  // Reset color after each ingredient
    }
}

// Function to print the recipe with colored ingredients
void printRecipe(const LarbRecipe& recipe) {
    cout << "\033[31mMeats: \033[0m";
    printIngredientWithType(recipe.mainIngredients, "meat");
    cout << endl;
    cout << "\033[38;5;214mSpices: \033[0m";
    printIngredientWithType(recipe.spices, "spice");
    cout << endl;
    cout << "\033[38;5;94mHerbs: \033[0m";
    printIngredientWithType(recipe.herbs, "herb");
    cout << endl;
    cout << "\033[32mVegetables: \033[0m";
    printIngredientWithType(recipe.specialIngredients, "vegetable");
    cout << endl << "\n----------------------\n" << endl;
}
...
void shownPlayerItem(Player player) {
    ...
    cout << "\033[1m\033[31mMeats: \033[0m " << player.mainIngredients << "(want more: " <<  player.recipe.mainIngredients.size() - player.mainIngredients << " )" << endl;
    cout << "\033[1m\033[38;5;214mSpices: \033[0m " << player.spices << "(want more: " <<  player.recipe.spices.size() - player.spices << " )" << endl;
    cout << "\033[1m\033[38;5;94mHerbs: \033[0m " << player.herbs << "(want more: " <<  player.recipe.herbs.size() - player.herbs << " )" << endl;
    cout << "\033[1m\033[32mVegetables: \033[0m " << player.specialIngredients << "(want more: " <<  player.recipe.specialIngredients.size() - player.specialIngredients << " )" << endl;
}
